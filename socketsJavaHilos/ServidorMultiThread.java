...
public class ServidorMultiThread extends Thread{
    //Variables estatica para que sea unica en la clase
    static ServerSocket serverSocket = null;
    //Variable de instancia para ser creada en cada nueva instancia
    Socket socket = null;
    ...
    public static void main(String a[]){
        ...
        while(true){
            try{
                ...
                //Asigna el socket local a la variable de instancia
                s.socket = socket;
